...
jest.mock("../../messaging/public/http", () => {
  ...
  return {
    ...
    createPresenceHandler: () => mockOk,
    createReactionHandler: () => mockOk,
    deleteReactionHandler: () => mockOk,
    editMessageHandler: () => mockOk,
    deleteMessageHandler: () => mockOk,
    listPublicConversationsHandler: () => mockOk,
    getPublicConversationHandler: () => mockOk,
    listInternalTemplatesHandler: mockOk,
    createInternalTemplateHandler: mockOk,
    updateInternalTemplateHandler: mockOk,
    deleteInternalTemplateHandler: mockOk,
    renderInternalTemplateHandler: mockOk,
    getMessageMediaHandler: mockOk,
    requireApiScope: () =>
