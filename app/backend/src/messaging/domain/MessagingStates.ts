...
export const CHANNEL_DELIVERY_HEALTH = {
  HEALTHY: "healthy",
  DEGRADED: "degraded"
} as const;

export type ChannelDeliveryHealthValue =
  (typeof CHANNEL_DELIVERY_HEALTH)[keyof typeof CHANNEL_DELIVERY_HEALTH];
...
// Janela em que duas falhas consecutivas de confirmação de entrega degradam a
// saúde do canal. Uma falha isolada nunca degrada.
export const DELIVERY_HEALTH_WINDOW_MS = 10 * 60_000;
